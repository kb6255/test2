...
#define W25X_ChipErase			  0xC7 //全片擦除命令 
...
void SPI_Flash_Erase_Sector(u16 Dst_Addr);//扇区擦除
void SPI_Flash_Wait_Busy(void);           //等待空闲
void SPI_Flash_PowerDown(void);           //进入掉电模式
void SPI_Flash_WAKEUP(void);			        //唤醒
void SPI_FLASH_BufferWrite(u8* pBuffer, u32 WriteAddr, u16 NumByteToWrite);//连续写入（自动擦除）
#endif
