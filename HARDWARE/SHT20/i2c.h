...
//SDA		PB11
//SCL		PB10
#define SDA_H	GPIO_SetBits(GPIOB, GPIO_Pin_8)
#define SDA_L	GPIO_ResetBits(GPIOB, GPIO_Pin_8)
#define SDA_R	GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_8)

#define SCL_H	GPIO_SetBits(GPIOB, GPIO_Pin_9)
#define SCL_L	GPIO_ResetBits(GPIOB, GPIO_Pin_9)
